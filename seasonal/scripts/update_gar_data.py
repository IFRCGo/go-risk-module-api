...
def update_gar_data(file):
    ...
    for i in range(2, max_rows + 1):
        ...
        economic_loss_return_period_20_years = parse_empty_cell_value(worksheet.cell(row=i, column=5).value)
        economic_loss_return_period_25_years = parse_empty_cell_value(worksheet.cell(row=i, column=6).value)
        economic_loss_return_period_50_years = parse_empty_cell_value(worksheet.cell(row=i, column=7).value)
        economic_loss_return_period_100_years = parse_empty_cell_value(worksheet.cell(row=i, column=8).value)
        economic_loss_return_period_250_years = parse_empty_cell_value(worksheet.cell(row=i, column=9).value)
        economic_loss_return_period_500_years = parse_empty_cell_value(worksheet.cell(row=i, column=10).value)
        if Country.objects.filter(name=country).exists():
            ...
            if economic_loss_return_period_20_years:
                economic_loss_return_period_20_years = economic_loss_return_period_20_years * 1000000
            ...
            economic_loss_return_period_10_years = {
                'economic_loss': economic_loss_return_period_10_years
            }
            economic_loss_return_period_20_years = {
                'economic_loss': economic_loss_return_period_20_years
            }
            economic_loss_return_period_25_years = {
                'economic_loss': economic_loss_return_period_25_years
            }
            economic_loss_return_period_50_years = {
                'economic_loss': economic_loss_return_period_50_years
            }
            economic_loss_return_period_100_years = {
                'economic_loss': economic_loss_return_period_100_years
            }
            economic_loss_return_period_250_years = {
                'economic_loss': economic_loss_return_period_250_years
            }
            economic_loss_return_period_500_years = {
                'economic_loss': economic_loss_return_period_500_years
            }
            data = {
                'country': Country.objects.filter(name=country).first(),
                'hazard_type': hazard_type,
                'ten_years': economic_loss_return_period_10_years,
                'twenty_years': economic_loss_return_period_20_years,
    ...
    for i in range(1, max_rows + 1):
        ...
        population_exposure_return_period_20_years = parse_empty_cell_value(worksheet1.cell(row=i, column=5).value)
        population_exposure_return_period_25_years = parse_empty_cell_value(worksheet1.cell(row=i, column=6).value)
        population_exposure_return_period_50_years = parse_empty_cell_value(worksheet1.cell(row=i, column=7).value)
        population_exposure_return_period_100_years = parse_empty_cell_value(worksheet1.cell(row=i, column=8).value)
        population_exposure_return_period_250_years = parse_empty_cell_value(worksheet1.cell(row=i, column=9).value)
        population_exposure_return_period_500_years = parse_empty_cell_value(worksheet1.cell(row=i, column=10).value)
        if Country.objects.filter(name=country).exists():
            gar_hazard = GarHazardDisplacement.objects.filter(
                ...
                twenty_years=models.Func(
                    ...
                    models.Value(['population_exposure']),
                    models.Value(population_exposure_return_period_20_years, models.JSONField()),
                    function="jsonb_set"
                ),
                ...
                hundred_years=models.Func(
                    ...
                    models.Value(['population_exposure']),
                    models.Value(population_exposure_return_period_100_years, models.JSONField()),
                    function="jsonb_set"
                ),
                two_hundred_fifty_years=models.Func(
                    models.F('two_hundred_fifty_years'),
                    models.Value(['population_exposure']),
                    models.Value(population_exposure_return_period_250_years, models.JSONField()),
                    function="jsonb_set"
                ),
                five_hundred_years=models.Func(
                    models.F('five_hundred_years'),
                    models.Value(['population_exposure']),
                    models.Value(population_exposure_return_period_500_years, models.JSONField()),
                    function="jsonb_set"
                ),
            )
