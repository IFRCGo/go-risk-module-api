...
class Idmc(models.Model):
    ...
    april = models.FloatField(verbose_name=_("april"), null=True, blank=True)
    may = models.FloatField(verbose_name=_("may"), null=True, blank=True)
    june = models.FloatField(verbose_name=_("june"), null=True, blank=True)
    july = models.FloatField(verbose_name=_("july"), null=True, blank=True)
    august = models.FloatField(verbose_name=_("august"), null=True, blank=True)
    september = models.FloatField(verbose_name=_("september"), null=True, blank=True)
...
class IdmcSuddenOnset(models.Model):
    country = models.ForeignKey(Country, on_delete=models.CASCADE, verbose_name=_("country"), null=True, blank=True)
    hazard_type = models.CharField(max_length=100, verbose_name=_("hazard type"), choices=HazardType.choices, blank=True)
    annual_average_displacement = models.IntegerField(null=True, blank=True, verbose_name=_("annual average displacement"))
    return_period_20_years = models.IntegerField(null=True, blank=True, verbose_name=_("return period 20 years"))
    return_period_50_years = models.IntegerField(null=True, blank=True, verbose_name=_("return period 50 years"))
    return_period_100_years = models.IntegerField(null=True, blank=True, verbose_name=_("return period 100 years"))
    return_period_250_years = models.IntegerField(null=True, blank=True, verbose_name=_("return period 250 years"))
    return_period_1000_years = models.IntegerField(null=True, blank=True, verbose_name=_("return period 1000 years"))
    return_period_1500_years = models.IntegerField(null=True, blank=True, verbose_name=_("return period 1500 years"))
...
class GarHazard(models.Model):
    country = models.ForeignKey(Country, on_delete=models.CASCADE, verbose_name=_("country"), null=True, blank=True)
    hazard_type = models.CharField(max_length=100, verbose_name=_("hazard type"), choices=HazardType.choices, blank=True)
    return_period_20_years = models.FloatField(null=True, blank=True, verbose_name=_("return period 20 years"))
    return_period_25_years = models.FloatField(null=True, blank=True, verbose_name=_("return period 25 years"))
    return_period_50_years = models.FloatField(null=True, blank=True, verbose_name=_("return period 50 years"))
    return_period_100_years = models.FloatField(null=True, blank=True, verbose_name=_("return period 100 years"))
    return_period_250_years = models.FloatField(null=True, blank=True, verbose_name=_("return period 250 years"))
    return_period_500_years = models.FloatField(null=True, blank=True, verbose_name=_("return period 500 years"))
...
class GarHazardDisplacement(models.Model):
    ...
    one_thousand_years = models.JSONField(blank=True, null=True, default=dict, verbose_name=_("One Thousand years"))
    one_thousand_five_hundred_years = models.JSONField(
        blank=True, null=True, default=dict, verbose_name=_("One Thousand Five hundred years")
    )
...
class GarProbabilistic(models.Model):
    country = models.ForeignKey(Country, on_delete=models.CASCADE, verbose_name=_("country"), null=True, blank=True)
    hazard_type = models.CharField(max_length=100, verbose_name=_("hazard type"), choices=HazardType.choices, blank=True)
    absolute_loss_in_million = models.FloatField(verbose_name=_("Absolute loss in Million"), null=True, blank=True)
    capital_stock_percentage = models.FloatField(verbose_name=_("Capital stock percentage"), null=True, blank=True)
    gfcf = models.FloatField(verbose_name=_("GFCF"), null=True, blank=True)
    social_exp = models.FloatField(verbose_name=_("Social Exp"), null=True, blank=True)
    total_revenue = models.FloatField(verbose_name=_("Total Revenue"), null=True, blank=True)
    gross_saving = models.FloatField(verbose_name=_("Gross Saving"), null=True, blank=True)
...
class IpcMonthly(models.Model):
    ...
    estimation_type = models.CharField(
        max_length=100, verbose_name=_("estimation type"), choices=EstimationType.choices, blank=True
    )
...
class ThinkHazardInformation(models.Model):
    ...
    country = models.ForeignKey(Country, on_delete=models.CASCADE)
    hazard_level = models.CharField(max_length=100, verbose_name=_("hazard level"), choices=ThinkHazardLevel.choices)
...
class PossibleEarlyActions(models.Model):
    country = models.ForeignKey(Country, on_delete=models.CASCADE, verbose_name=_("country"))
    hazard_type = models.CharField(max_length=100, verbose_name=_("hazard type"), choices=HazardType.choices, blank=True)
    early_actions = models.TextField(verbose_name=_("Possible Early Actions"), null=True, blank=True)
    hazard_name = models.CharField(max_length=255, verbose_name=_("Hazard Name"), null=True, blank=True)
    location = models.TextField(verbose_name=_("Location Description"), null=True, blank=True)
    sectors = models.ManyToManyField(PossibleEarlyActionsSectors, verbose_name=_("Sectors"), blank=True)
    intended_purpose = models.TextField(verbose_name=_("Intended Purpose"), null=True, blank=True)
    ...
    effective_time_raw = models.CharField(max_length=255, verbose_name=_("Effective Time Raw"), null=True, blank=True)
    number_of_people_covered = models.IntegerField(verbose_name=_("Number of People Covered"), null=True, blank=True)
    number_of_people_at_risk = models.IntegerField(verbose_name=_("Number of people At Risk"), null=True, blank=True)
    scalability = models.CharField(verbose_name=_("Scalability"), null=True, blank=True, max_length=255)
    cross_cutting = models.TextField(verbose_name=_("Cross Cutting"), null=True, blank=True)
    resources_used = models.TextField(verbose_name=_("Resources Used"), null=True, blank=True)
    impact_action = models.TextField(verbose_name=_("Impact Action"), null=True, blank=True)
    evidence_of_sucess = models.TextField(verbose_name=_("Evidence of Sucess"), null=True, blank=True)
    resource = models.TextField(verbose_name=_("Resource"), null=True, blank=True)
    link_to_resources = models.CharField(verbose_name=_("Link To Resources"), null=True, blank=True, max_length=255)
    exist_in_hub = models.BooleanField(verbose_name=_("Exist in Hub"), null=True, blank=True)
...
class PublishReportProgram(models.Model):
    ...
    inactive = models.BooleanField(verbose_name=_("Inactive"), null=True, blank=True)
    country = models.ForeignKey(Country, verbose_name=_("Country"), on_delete=models.CASCADE)
    program_name = models.CharField(max_length=255, verbose_name=_("Program Name"))
    program_manager = models.CharField(max_length=255, verbose_name=_("Program Manager"))
    area = models.CharField(max_length=255, verbose_name=_("Area"), null=True, blank=True)
    description = models.TextField(verbose_name=_("Description"), null=True, blank=True)
    communities = models.TextField(verbose_name=_("Communities"), null=True, blank=True)
    bread_cumbs = models.TextField(verbose_name=_("Bread Cumbs"), null=True, blank=True)
    accuracy_level = models.CharField(verbose_name=_("Accuracy"), null=True, blank=True, max_length=255)
    community_engagement = models.TextField(verbose_name=_("Community Engagement"), null=True, blank=True)
    measurement_assignment = models.TextField(verbose_name=_("Measurement Assignment"), null=True, blank=True)
    community_vca = models.TextField(verbose_name=_("Community VCA"), null=True, blank=True)


class PublishReport(models.Model):
    program = models.ForeignKey(PublishReportProgram, verbose_name=_("Program Name"), on_delete=models.CASCADE)
    publish_report_id = models.CharField(verbose_name=_("Publish Report"), max_length=255, null=True, blank=True)
    ...
    attachment_name = models.CharField(verbose_name=_("Attachment Name"), null=True, blank=True, max_length=255)
    attachment = models.CharField(verbose_name=_("Attachment"), null=True, blank=True, max_length=255)
    attachment_url = models.CharField(verbose_name=_("Attachment URL"), max_length=255, null=True, blank=True)
...
class GwisSeasonal(models.Model):
