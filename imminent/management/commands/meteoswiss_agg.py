    ...
    def handle(self, *args, **kwargs):
        ...
        def get_latest_meteo_swiss_data(hazard_name, country_name):
            data = (
                MeteoSwiss.objects.filter(
                    impact_type="exposed_population_18mps", hazard_name=hazard_name, country__name=country_name
                )
        ...
        def get_event_details(hazard_name, country_name):
            latest_dates = (
                ...
                .values("impact_type")
                .annotate(latest_initialization_date=Max("initialization_date"))
            )
        ...
        def create_meteo_swiss_agg_entry(event, latest_data, event_details):
            ...
            meteo_agg = MeteoSwissAgg.objects.filter(country=country, hazard_name=hazard_name, updated_at=updated_at)
        ...
        event_query = (
            ...
            .values("hazard_name", "country__name", "model_name")
            .distinct()
            .annotate(
